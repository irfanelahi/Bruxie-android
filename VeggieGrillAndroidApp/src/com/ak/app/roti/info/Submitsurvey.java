...
public class Submitsurvey {
	private static Submitsurvey screen;
	private RelativeLayout mParentLayout;
	private LayoutInflater mInflater;
	private Tabbars mHomePage;

	public static Submitsurvey getInstance() {
		if (screen == null)
			screen = new Submitsurvey();
		return screen;
	}
...
//				.set(Fields.SCREEN_NAME, "About Us").build());
		...
		AppConstants.kingthingsTextView(thanku2, 28, AppConstants.COLOR_BLACK_PAGETITLE, mHomePage.getAssets());
