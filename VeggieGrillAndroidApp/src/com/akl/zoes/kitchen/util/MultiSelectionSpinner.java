	...
	public MultiSelectionSpinner(final Context context, AttributeSet attrs) {
		...
		simple_adapter = new ArrayAdapter<String>(context,
			...
			public View getView(int position, View convertView,
				...
				((TextView) v).setTextColor(Color.parseColor("#04090e"));
...
//				v.setBackgroundColor(Color.GREEN);
	...
	public void onClick(DialogInterface dialog, int which, boolean isChecked) {
		...
		if (!buildSelectedItemString().trim().equals(""))
			Servey.getInstance().answersId[rowOfQuestion] = getSelectedItemsAsString();
		else
			Servey.getInstance().answersId[rowOfQuestion] = "";

		Servey.getInstance().activateButtonSubmit(questions, questionType,
	...
	public void setItems(String[] items, String[] values,
			Questions[] questions, String questionType, int rowOfQuestion) {
		_items = items;
		this.values = values;
